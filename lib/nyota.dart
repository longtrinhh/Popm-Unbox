...
class NyotaPage extends StatelessWidget {
  final List<Map<String, dynamic>> unboxedCharacters;
  final Function(List<Map<String, dynamic>>) updateCharacters;

  const NyotaPage({super.key, required this.unboxedCharacters, required this.updateCharacters});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nyota Fluffy Life',
...
class _CharacterSelectionState extends State<CharacterSelection> {
  final List<Map<String, dynamic>> _characters = [
    {'name': 'Kitten Hug', 'image': 'assets/nyota/n1.webp', 'probability': 0.08},
    {'name': 'See Love', 'image': 'assets/nyota/n2.webp', 'probability': 0.1},
    {'name': 'Warm Sunlight', 'image': 'assets/nyota/n3.webp', 'probability': 0.1},
    {'name': 'Little Mountain', 'image': 'assets/nyota/n4.webp', 'probability': 0.1},
    {'name': 'Our Secret', 'image': 'assets/nyota/n5.webp', 'probability': 0.08},
    {'name': 'Calling', 'image': 'assets/nyota/n6.webp', 'probability': 0.1},
    {'name': 'Lost Star', 'image': 'assets/nyota/n7.webp', 'probability': 0.1},
    {'name': 'Brief Escape', 'image': 'assets/nyota/n8.webp', 'probability': 0.1},
    {'name': 'Home', 'image': 'assets/nyota/n9.webp', 'probability': 0.1},
                ...
                child: Container(
                  decoration: BoxDecoration(
                    image: const DecorationImage(
                      image: AssetImage('assets/nyota/nbox.jpg'),
                      fit: BoxFit.cover,
                    ),
